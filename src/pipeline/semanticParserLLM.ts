...
import { ResultadoSemanticoLLM } from "../schema/bilhete.schema";
import { LlmClient, defaultLlmClient } from "../utils/llmClient";

export async function semanticParserLLM(
  betLines: string[],
  client: LlmClient = defaultLlmClient,
): Promise<ResultadoSemanticoLLM> {
