...
exports.readKeysFromEnv = readKeysFromEnv;
class KeyRotator {
    constructor(opts) {
        this.callCounter = 0; // Contador atômico para distribuir chaves entre chamadas concorrentes
        ...
        this.defaultCooldownMs = opts.defaultCooldownMs ?? 30000;
        this.rateLimitCooldownMs = opts.rateLimitCooldownMs ?? 30000;
        this.authCooldownMs = opts.authCooldownMs ?? 10 * 60000;
