...
exports.isLikelyBetLine = isLikelyBetLine;
exports.extractRawBets = extractRawBets;
...
function isLikelyBetLine(line) {
    ...
    if (ODDS_ONLY_REGEX.test(line.trim()))
        return false;
    // Remove ruído OCR comum
    if (NOISE_REGEX.test(line.trim()))
        return false;
